...
############################################################
####   run BlastX in Bash against SwissProt database    ####
############################################################


########## stats after Uniprot blastx ############
...
############################################################
####       check length distrubution of nirS ASVs       ####
############################################################
...
###############################################################
###########       length selection in Bash       ##############
###############################################################

# filter sequence by the length of 220-240 bp
